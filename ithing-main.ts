 ...
 * Ultrasonic module
 */
//% weight=100 color=#00278D icon="\uf124" block="Ultrasonic"
//% 
namespace UltrasonicPac {
    /**
    * Obtain real-time ultrasonic distance (cm)
    * @param echo 超声波echo信号
    * @param trig 超声波trig信号
    */
    //% weight=97 blockId=Ultrasonic block="Ultrasonic distance(ECHO %echo|TRIG %trig)"
    //% group="超声波传感器"
 ...
 * 安芯教育图形块
 */
//% weight=100 color=#50A820 icon="\uf162" block="Nixie tube"
...
namespace anxinSegPac {
    ...
    export class TM1637LEDs {
        ...
        /**
         * Set the nixie tube brightness, the range is [0-8], 0 indicates off.
         * @param val 数码管的亮度值, eg: 7
         */
        //% blockId="TM1637_set_intensity" block="%tm|Set the brightness to %val"
        ...
        /**
         * Displays the number in the specified location.
         * @param num 要显示的数字, eg: 5
         * @param bit 显示的位置, eg: 0
         */
        //% blockId="TM1637_showbit" block="%tm|Displays a number %num |at %bit"
        ...
        //   */
        // //% blockId="TM1637_showhex" block="%tm|Displays a hexadecimal number %num"
        // //% weight=82 blockGap=8
        // //% parts="TM1637"
		// //% color="#50A820"
		// //% group="数码管显示"
        ...
        /**
         * Show or hide the decimal point
         * @param bit 是小数点位置, eg: 1
         * @param show 是否显示, eg: true
         */
        //% blockId="TM1637_showDP" block="%tm|The decimal point | at the %bit position shows the status: %show"
         ...
         * Display 0.
         */
        //% blockId="TM1637_clear" block="%tm Display to zero."
         ...
         */
        //% blockId="TM1637_on" block="Light up the nixie tube %tm"
        ...
        /**
         * Turn off the nixie tube LED.
         */
        //% blockId="TM1637_off" block="Turn off the nixie tube LED %tm"
    ...
    /**
     * Create a nixie tube variable.
     * @param clk 引脚CLK, eg: DigitalPin.P1
     * @param dio 引脚DIO, eg: DigitalPin.P2
     */
    //% weight=195 blockGap=8
    //% blockId="TM1637_create" block="Create a nixie tube variable %clk|DIO %dio"
	//% color="#50A820"
	//% group="数码管显示"
 ...
 * 安芯教育图形块
 */
//% weight=99 color=#008fbe icon="\uf0eb" block="LED lanterns"
namespace anxinRGBLeds {
    ...
    export class Strip {
         ...
         */
        //% blockId="neopixel_set_strip_rainbow" block="%strip|from %startHue|to %endHue|show rainbow" 
        //% weight=69 blockGap=8
        //% parts="neopixel"
		//% group="彩灯"
         ...
         * @param rgb LED的RGB颜色
         */
        //% blockId="neopixel_set_pixel_color" block="%strip|Set the color %rgb=neopixel_colors| of the location to %pixeloffset" 
        //% blockGap=8
        //% weight=69
        //% parts="neopixel" 
		//% group="彩灯"
         ...
         * @param white LED的亮度
         */
        //% blockId="neopixel_set_pixel_white" block="%strip|Set the %pixeloffset| LED brightness in the light strip as %white" 
        //% blockGap=8
        //% weight=69
        //% parts="neopixel"
		//% group="彩灯"
         ...
         */
        //% blockId="neopixel_show" block="%strip|Display" blockGap=8
        //% weight=69
        //% parts="neopixel"
		//% group="彩灯"
        show() {
         ...
         */
        //% blockId="neopixel_clear" block="%strip|Close"
        //% weight=69
        //% parts="neopixel"
		//% group="彩灯"
        clear(): void {
         ...
         */
        //% blockId="neopixel_set_brightness" block="%strip|Set the brightness value to %brightness" blockGap=8
        //% weight=69
        //% parts="neopixel" 
		//% group="彩灯"
         ...
         */
        //% weight=69
        //% blockId="neopixel_range" block="%strip|From %start|display %length| LED"
        //% parts="neopixel"
         ...
         */
        //% blockId="neopixel_shift" block="%strip|The number of pixels to move forward is %offset" blockGap=8
        //% weight=69
        //% parts="neopixel"
		//% group="彩灯"
         ...
         */
        //% blockId="neopixel_rotate" block="%strip|The number of pixels to rotate forward is %offset" blockGap=8
        //% weight=69
        //% parts="neopixel"
		//% group="彩灯"
     ...
     */
    //% blockId="neopixel_create" block="Pin %pin|,num of leds %numleds|,Mode %mode"
    //% weight=69 blockGap=8
    //% parts="neopixel"
    //% trackArgs=0,2
    ...
    */
     ...
     */
	//% weight=69
    //% blockId=neopixelHSL block="hue %h|saturability %s|luminosity  %l"
	//% group="彩灯"
 ...
 * 安芯教育图形块
 */
//% weight=100 color=#BB2700 icon="\uf2c9" block="Temperature"
namespace ntcPac {
    /**
     * Convert NTC ADC data to temperature
     * @param adcpin 是ADC的输入引脚
     */
    //% weight=50 blockId="temperature" block="get temperature %adcpin"
    //% group="温度传感器"
